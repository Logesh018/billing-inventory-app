...
export const getOrderByPoNo = (PoNo) => axiosInstance.get(`/purchase-estimations/order/${PoNo}`, {
  headers: {
...
export const getEstimationPDF = (id) => axiosInstance.get(`/purchase-estimations/${id}/pdf`);  
