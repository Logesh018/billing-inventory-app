...
export default function JobWorksOrders() {
  ...
  const handleDelete = async (id) => {
    if (showConfirm("Are you sure you want to delete this JOB-Works order? This will also delete related purchase/production records.")) {
      try {
