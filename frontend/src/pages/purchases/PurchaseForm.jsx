...
const PurchaseForm = ({ initialValues, onSubmit, onCancel, submitLabel, isEditMode }) => {
  ...
  const handleSubmit = () => {
    // Convert purchase items to the format expected by the backend
        ...
        <div className="bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 rounded-lg p-3 shadow-sm">
          ...
          <div className="grid grid-cols-5 gap-3">
            ...
            <div>
              ...
              <div className="text-xs font-bold text-gray-900 dark:text-gray-100">{formData.PoNo || '-'}</div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-xs font-medium text-gray-900 dark:text-gray-100">{formData.buyerCode || '-'}</div>
            </div>
            <div>
              <label className="block text-[10px] font-medium text-gray-600 dark:text-gray-300 mb-0.5">Status</label>
              <div className="text-xs font-medium text-gray-900 dark:text-gray-100">{formData.orderStatus || '-'}</div>
            </div>
          </div>
            ...
            <div className="mt-2 pt-2 border-t border-gray-300 dark:border-gray-600">
              ...
              {formData.products.map((prod, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className={`grid gap-3 py-1.5 ${idx > 0 ? 'border-t border-gray-200 dark:border-gray-600' : ''}`}
                    style={{ gridTemplateColumns: '2fr 0.8fr 0.8fr 0.8fr 2fr 0.6fr' }}
                  >
                    <div className="text-[10px] font-semibold text-gray-900 dark:text-gray-100 break-words leading-tight">
                      {prod.productDetails?.name || '-'}
                    </div>
                    <div className="text-[10px] text-gray-800 dark:text-gray-200 break-words leading-tight">
                    ...
                    <div className="text-[10px] text-gray-800 dark:text-gray-200 font-mono leading-tight">
                    ...
                    <div className="text-[10px] font-bold text-blue-600 dark:text-blue-400 text-center">
                      {productTotal}
                    </div>
                  </div>
                );
