...
export default function SupplierForm({ onSubmit, onClose, initialValues = {} }) {
  ...
  useEffect(() => {
    if (initialValues && Object.keys(initialValues).length > 0) {
      setFormData({
        ...
        totalRequirements: initialValues.totalRequirements || 0,
        vendorCategory: initialValues.vendorGoods?.category || "Fabrics",
        accessoryName: initialValues.vendorGoods?.accessoryName || "",
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div>
                  ...
                  <input
                    placeholder="e.g., Garment, Fabric"
                    className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400"
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="0"
                    className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400"
                    value={formData.totalRequirements}
                    onChange={(e) => handleChange('totalRequirements', parseInt(e.target.value) || 0)}
                  />
                </div>
