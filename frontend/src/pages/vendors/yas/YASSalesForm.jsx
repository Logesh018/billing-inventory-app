...
export default function YASSalesForm({ onSubmit, onClose, initialValues = {} }) {
  ...
  useEffect(() => {
    if (initialValues && Object.keys(initialValues).length > 0) {
      setFormData({
        yasBuyerType: initialValues.yasBuyerType || "",
  ...
  const validateForm = () => {
    ...
    if (!formData.yasBuyerType) {
      newErrors.yasBuyerType = "YAS Buyer Type is required";
    }
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.error("Error submitting YAS buyer:", error);
      alert(`Failed to save YAS buyer: ${error.message}`);
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-6">
          <div className="text-center mb-6">
            <h1 className="text-2xl font-bold text-gray-800">
              {initialValues._id ? "Edit YAS Buyer" : "Create New YAS Buyer"}
            </h1>
          </div>

          <div className="space-y-6 max-h-[calc(100vh-200px)] overflow-y-auto pr-2">
            {/* Basic Information - WITH BUYER TYPE IN SAME ROW */}
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {/* First Row: Name, Code, Buyer Type */}
                <div>
                ...
                <div>
                  ...
                  <input
                    placeholder="Auto-generated (YAS###)"
                ...
                <div>
                  ...
                  <select
                    ...
                    value={formData.yasBuyerType}
                    onChange={(e) => handleChange('yasBuyerType', e.target.value)}
                  >
                    <option value="">Select buyer type</option>
                    <option value="Distributors">Distributors</option>
                    <option value="Agents">Agents</option>
                    <option value="Direct Retailer">Direct Retailer</option>
                    <option value="Yas Shop">Yas Shop</option>
                    <option value="Yas Online Store">Yas Online Store</option>
                  </select>
                  {errors.yasBuyerType && (
                    <p className="text-xs text-red-500 mt-1">{errors.yasBuyerType}</p>
                  )}
                </div>
          ...
          <div className="flex justify-end gap-3 pt-6 mt-6 border-t border-gray-200">
            ...
            <button
              ...
              disabled={loading}
              className="bg-purple-600 hover:bg-purple-700 text-white rounded-lg px-6 py-2 text-sm font-medium disabled:opacity-50 transition-colors"
            >
              {loading ? "Saving..." : initialValues._id ? "Update YAS Buyer" : "Create YAS Buyer"}
            </button>
          </div>
        </div>
      </div>
