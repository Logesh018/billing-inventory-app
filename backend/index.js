...
import storeEntryRoutes from "./src/routes/storeEntryRoutes.js";
import storeLogRoutes from "./src/routes/storeLogRoutes.js";
...
app.use("/api/store-entries", storeEntryRoutes);
app.use("/api/store-logs", storeLogRoutes);
