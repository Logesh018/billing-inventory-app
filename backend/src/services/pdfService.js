...
/**
 * Main PDF generator for Credit/Debit Notes
 */
async generateNotePDF(note) {
  try {
    ...
    const refDate = note.referenceDate 
      ? new Date(note.referenceDate).toLocaleDateString("en-IN")
      : "";
    ...
    const data = {
      ...
      noteDate: new Date(note.noteDate).toLocaleDateString("en-IN"),
      ...
      // Business Details
      "business.name": note.businessDetails?.name || "NILA TEXGARMENTS",
      "business.address": note.businessDetails?.address || "",
      "business.city": note.businessDetails?.city || "",
      "business.state": note.businessDetails?.state || "",
      "business.pincode": note.businessDetails?.pincode || "",
      "business.gst": note.businessDetails?.gst || "",
      "business.pan": note.businessDetails?.pan || "",
      "business.accountNumber": note.businessDetails?.accountNumber || "",
      "business.ifsc": note.businessDetails?.ifsc || "",
      "business.branch": note.businessDetails?.branch || "",
      "business.bankName": note.businessDetails?.bankName || "",
    ...
    console.log('✅ Note PDF uploaded successfully:', uploadResult.url);
